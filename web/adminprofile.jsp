                            ...
                            <div class="row m-l-0 m-r-0">
                                ...
                                <div class="col-sm-8">
                                    <div class="card-block">
                                        <h4 class="m-b-20 p-b-5 b-b-default f-w-600">Admin Information</h4>
                                        <div class="row">
                                            <div class="col-sm-12">
                                        ...
                                        <ul class="social-link list-unstyled m-t-40 m-b-10">
                                            <li style="padding: 1px 8px; background-color: #007bff; border-radius: 15px;"><a href="adminupdate.jsp" style="text-decoration: none; color: white; font-size: 16px; font-weight: bold;"><i>Edit Info</i></a></li>
                                        </ul>
                                    </div>
                                </div>
                            </div>
