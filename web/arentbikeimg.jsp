<%-- 
    Document   : arentbikeimg
    Created on : 28-Feb-2024, 8:39:20 pm
    Author     : neera
--%>
...
<html>
    ...
    <body>
        <div class="background-image">
            ...
            <!--form start-->
            <form action="RentBike?action=rentbikeimg" method="post" enctype="multipart/form-data">
                <h3 style="color: black; padding: 17px; text-align: center;">Rent Bike Image</h3>
