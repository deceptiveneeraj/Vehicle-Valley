<%-- 
    Document   : admin
    Created on : 17-Feb-2024, 11:54:03 am
    Author     : neera
--%>
...
<html>
    <head>
        ...
        <title>Admin Login - Vehicle Valley</title>
    ...
    <body>
        <div class="background-image">
            ...
            <form action="AdminLoginSign?action=admin" method="post">
                <h3 style="color: black; padding: 17px; text-align: center;">Admin Login Here</h3>
                ...
                <br><br>
                <label><a href='adminforgot.jsp' style="text-decoration: none; color: green; font-size: 20px;">Forgot Password</a></label>
                <br>
            </form>
        </div>
    </body>
