<%-- 
    Document   : arentbike
    Created on : 28-Feb-2024, 8:39:01 pm
    Author     : neera
--%>
    ...
    <body>
        <div class="background-image">
            ...
            <form action="RentBike?action=rentbike" method="post" style="">
                ...
                <div class="form-floating mb-3">
                    <input type="text" class="form-control" id="floatingInput" name="fcapacity" placeholder="Mileage" required="">
                ...
                <div class="form-floating mb-3" style="margin-top: 20px;">
                    ...
                    <label for="floatingInput">Bike Rent Price Per Day</label>
                </div>
